...
caminho_arquivos = r"C:\Users\rayner.santos\Downloads\Renomear"
arquivo_excel = r"C:\Users\rayner.santos\Downloads\Renomear\Arquivos_Excluir.xlsx"
...
df = pd.read_excel(arquivo_excel, sheet_name="Plan1", dtype=str)  # Garante que todas as colunas sejam strings
